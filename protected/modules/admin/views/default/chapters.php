        ...
        <section class="content">
    			<div class="row">
	            	...
	            	<div class="box-header">
	          			<h3 class="box-title"><?php echo CHtml::link('AREA '.$region->area_no, array('/admin/default/index'))?> - <?php echo $region->region; ?></h3>
	          			<h3 class="box-title pull-right">Total: <?php echo User::model()->getTotalUsers($region->area_no, $region->id); ?></h3>
	                </div><!-- /.box-header -->
