<tr>
	...
	<td>
		<?php
			...
			echo CHtml::link('<span class="btn btn-primary">Activate</span>', array('/admin/account/activateaccount', 'id' => $data->account_id), array('class' => 'btn', 'confirm' => "Are you sure you want to deactivate this account?", 'title' => 'Delete'));
		?>
	</td>
</tr>