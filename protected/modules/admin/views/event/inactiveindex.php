      ...
      <div class="content-wrapper">
        ...
        <!-- Content Header (Page header) -->
          ...
          <div class="row visible-sm visible-xs" style="margin-left: 5px; margin-right: 5px; margin-top:0px;">
              <h3>Events  
                <a href="<?php echo Yii::app()->baseUrl; ?>/index.php/admin/event/create" class="btn btn-primary btn-sm pull-right"> <span class="glyphicon glyphicon-plus" style="margin-right:10px"></span> Create Event </a>
              </h3>
          </div>
          ...
          <div class="row hidden-sm hidden-xs">
            ...
            <div class="col-md-6">
              <a href="<?php echo Yii::app()->baseUrl; ?>/index.php/admin/event/create" class="btn btn-primary btn-md pull-right"> <span class="glyphicon glyphicon-plus" style="margin-right:10px"></span> Create Event </a>
            </div>
          </div>
        </section>
                ...
                <div class="row" id="searchFilters" style="margin-bottom:20px;">
                  ...
                  <div class="col-md-10">
                    <p>
                      ...
                      <form method="GET" name="search" action="<?php echo $this->createUrl('event/inactiveindex'); ?>">
              ...
              <div class="col-md-12">
                <div class="box">
                      <div class="box-header">
                        <h3 class="box-title">List of Inactive Events </h3>
                        </div><!-- /.box-header -->
                      <div class="box-body table-responsive no-padding">
                      <?php  $this->widget('zii.widgets.CListView', array(
                      'dataProvider'=>$inactivelistEventsDP,
                      'itemView'=>'_list_events_inactive',
