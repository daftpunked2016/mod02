<tr>
	...
	<td>
		<?php
			...
			echo CHtml::link('<span class="btn btn-warning btn-sm">Activate</span>', array('event/activateevent', 'id' => $data->id), array('confirm' => "Are you sure you want to activate this Event?", 'title' => 'Activate Event'));
		?>
	</td>
</tr>