    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
          ...
          <h1>
            Inactive Accounts
            <small>preview of inactive accounts</small>
          </h1>
        </section>
            ...
            <div class="col-md-12 col-lg-12">
              ...
              <div class="well">
                ...
                <p>
                  ...
                  <form method="GET" name="search" action="<?php echo $this->createUrl('account/inactiveindex'); ?>">
                    ...
                    <div class="col-xs-6 col-lg-3">
                      ...
                      <select name="chapter" class="form-control">
                        ...
                        <?php $chapters = Chapter::model()->findAll(array('order' => 'chapter')); 
                    ...
                    <div class="col-xs-6 col-lg-3">
                      ...
                      <select name="position" class="form-control">
                        <option value="">Please Select..</option>
                        <?php $position = Position::model()->findAll(array('order' => 'category')); 
                                    foreach($position as $pos)
                                      echo "<option value='".$pos->id."'>".$pos->category." / ".$pos->position."</option>";
                                  ?>
                      </select>
                    </div>
                      ...
                      <div class="row wrappers transaction_wrapper">
                        <div class="col-md-12">
                          <?php  $this->widget('zii.widgets.CListView', array(
                            'dataProvider'=>$userAccountsDP,
                            'itemView'=>'_view_user_inactive',
