  ...
  <body class="skin-black sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr>
                      ...
                      <td><?php echo $user->member_id ?>
                        <a href="#" data-toggle="modal" data-target="#memberIDmodal">
                          <span class="glyphicon glyphicon-pencil"></span>
                        </a>
                      </td>
                    </tr>
        ...
        <!-- Member ID Modal -->
        <div class="modal fade" id="memberIDmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel" align="center"><strong>Change Member ID</strong></h4>
              </div>
              <div class="modal-body">
                <div class="form">
                  <form method="post">
                    <label>Member ID:</label>
                    <input type="text" name="member_id" class="form-control" value="<?php echo $user->member_id; ?>" />
                </div>
                <div class="modal-footer">
                  <input type="submit" value="Save" class="btn btn-primary btn-flat"/>
                  <button type="button" class="btn btn-default btn-flat" data-dismiss="modal">Close</button>
