<tr>
	...
	<td><?php echo CHtml::encode($data->user->sen_no); ?></td>
	<td><?php echo CHtml::encode($data->user->getCompleteName2($data->user->account_id)); ?></td>
	<td>
		<?php
	...
	<td>
		<?php
			...
			echo CHtml::link('<span class="btn btn-danger">Deactivate</span>', array('/admin/account/deactivateaccount', 'id' => $data->id), array('class' => 'btn', 'confirm' => "Are you sure you want to deactivate this account?", 'title' => 'Delete'));
		?>
	</td>
</tr>