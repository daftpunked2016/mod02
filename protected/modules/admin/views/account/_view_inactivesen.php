<tr>
	...
	<td>
		<?php
			...
			echo CHtml::link('<span class="btn btn-success">Activate</span>', array('/admin/account/activateaccount', 'id' => $data->id), array('class' => 'btn', 'confirm' => "Are you sure you want to activate this account?", 'title' => 'Delete'));
		?>
	</td>
</tr>