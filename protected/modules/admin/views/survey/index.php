      ...
      <div class="content-wrapper">
        <!-- Content Header (Page header) -->
 		<section class="content-header">
          <h1>
            Survey
            <small>preview of surveys</small>
          </h1>
        </section>
		...
		?>
      	<div class="box">
      		<div class="box-header">
      			<div class="pull-left">
      				<h4><strong>Survey Management</strong></h4>
      			</div>
      			<div class="pull-right">
      				<?php echo CHtml::link('<span class="fa fa-plus"></span> Create Survey', array('survey/createsurvey'), array('class'=>'btn btn-primary btn-flat'))?>
      			</div>
      		</div>
      		<div class="box-body">
      		...
      		<div class="box-footer">Survey Management</div>
      	</div>
