...
<div class="form-group has-feedback">
  <?php echo $form->textField($model,'event_id', array('class'=>'form-control', 'type'=>'text', 'placeholder'=>'Event Code')); ?><span class="glyphicon glyphicon-search form-control-feedback"></span>
