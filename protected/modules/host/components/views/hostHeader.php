            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs"><?php echo $user->getHostCompleteName(); ?> <strong>(Host)</strong></span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      <a href="<?php echo Yii::app()->request->baseUrl; ?>/index.php/host/account/profile/id/<?php echo $user->account_id; ?>">
                        Host Account
                      </a>
