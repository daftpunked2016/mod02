  ...
  <div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="well">
            ...
            <div class="row" style="margin-bottom:15px;">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="bank_branch" name="bank_branch" value="<?php echo $payment->bank_branch; ?>" required />
                </div>
              </div>
            </div>
            ...
            <div class="row" style="margin-bottom:15px;">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="time" name="time" value="<?php echo $payment->time; ?>" required />
                </div>
              </div>
            </div>
            ...
            <div class="row" style="margin-bottom:15px;">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="amount" name="amount" placeholder="eg. 999.75" data-toggle="tooltip" data-placement="top" title="Input numerical values only." value="<?php echo $payment->amount; ?>" required />
                </div>
              </div>
            </div>
        ...
        <div class="row buttons">
          <?php
          if($resend == 1)
            echo CHtml::submitButton('Update & Resend', array('class'=>'btn btn-lg btn-primary pull-right', 'style'=>'margin-right:20px; margin-bottom:30px;', 'name'=>'update')); 
          else
            echo CHtml::submitButton('Update', array('class'=>'btn btn-lg btn-primary pull-right', 'style'=>'margin-right:20px; margin-bottom:30px;', 'name'=>'update')); 
          ?>
