...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'areacon_area_no'); ?>
		<?php echo $form->textField($model,'areacon_area_no'); ?>
		<?php echo $form->error($model,'areacon_area_no'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'host_account_id'); ?>
		<?php echo $form->textField($model,'host_account_id'); ?>
		<?php echo $form->error($model,'host_account_id'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'event_avatar'); ?>
		<?php echo $form->textField($model,'event_avatar'); ?>
		<?php echo $form->error($model,'event_avatar'); ?>
	</div>
